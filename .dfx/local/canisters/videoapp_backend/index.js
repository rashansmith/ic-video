...
export const canisterId = process.env.VIDEOAPP_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./videoapp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the videoapp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./videoapp_backend.did.js")._SERVICE>}
 */
