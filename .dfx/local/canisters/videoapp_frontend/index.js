...
import { idlFactory } from './videoapp_frontend.did.js';
export { idlFactory } from './videoapp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.VIDEOAPP_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./videoapp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the videoapp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./videoapp_frontend.did.js")._SERVICE>}
 */
export const videoapp_frontend = createActor(canisterId);
